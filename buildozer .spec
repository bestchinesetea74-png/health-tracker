...
#
# ВАЖНО: materialyoucolor==3.0.3 — версия ЗАФИКСИРОВАНА явно.
# Без явного номера версии pip подтягивал более старую версию пакета,
# где ещё не было модуля materialyoucolor.dynamiccolor.color_spec,
# который требует kivymd/theming.py — отсюда был постоянный
# ModuleNotFoundError даже после добавления materialyoucolor в список.
# materialshapes и pycairo — тоже обязательные зависимости текущей
# версии kivymd согласно официальному README на PyPI.
requirements = python3,kivy,kivymd,materialyoucolor==3.0.3,materialshapes,pycairo,exceptiongroup,asyncgui,asynckivy,pillow,google-api-python-client,google-auth,google-auth-oauthlib
