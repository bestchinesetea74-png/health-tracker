...
# materialyoucolor, exceptiongroup, asyncgui, asynckivy — обязательные
# зависимости kivymd>=2.0 для Android-сборки согласно официальному
# README kivymd (без них падает ModuleNotFoundError на разных этапах
# импорта kivymd.app / kivymd.theming).
requirements = python3,kivy,kivymd,materialyoucolor,exceptiongroup,asyncgui,asynckivy,pillow,google-api-python-client,google-auth,google-auth-oauthlib
