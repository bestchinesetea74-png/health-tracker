...
# materialyoucolor обязателен для kivymd>=2.0 (без него падает
# с ModuleNotFoundError при импорте kivymd.app).
requirements = python3,kivy,kivymd,materialyoucolor,pillow,google-api-python-client,google-auth,google-auth-oauthlib
